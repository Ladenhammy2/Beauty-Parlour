...
<html lang="en">
  <head>
    <title>BEAUTY PARLOUR | Home Page</title>
		          ...
		          <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text mt-5">
			            ...
			            <p class="mb-4">This parlour provides huge facilities with advanced technology equipments 
							and best quality service. Here we offer best treatment that you might have never experienced before.</p>  
		            </div>
		          </div>
	        	</div>
	        </div>
	...
	<div class="cont">
        ...
        <form action="includes/feedback.php" method="post">
			...
			<div class="form-group">
                ...
                <select name="rating" id="rating" style="max-width=100%">
